...
export default function ChatbotButton({ onClick }: { onClick?: () => void }) {
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <button
        onClick={onClick}
        className="group relative flex items-center justify-center w-[45px] h-[45px] rounded-full backdrop-blur-md bg-white/20 border-2 border-orange-400 text-gray-700 font-semibold hover:w-[125px] hover:rounded-[40px] focus:ring-2 focus:ring-orange-300 focus:outline-none transition-all duration-300 shadow-sm active:translate-x-[2px] active:translate-y-[2px] overflow-hidden"
